...
public record ArticleWithCommentsResponseV2(
    ...
    public static ArticleWithCommentsResponseV2 of(Long id, String title, String content, String hashtag, LocalDateTime createdAt, String email, String nickname, Set<ArticleCommentResponseV1> articleCommentsResponse) {
